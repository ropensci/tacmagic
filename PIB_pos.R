...
# A group of functions to create a PIB-positive cutoff and filter your SUVR data with it.

# This function removes entries greater than 1.5 standard deviations away from the means.
...
# This function determines a PIB-Positive cutoff based on the method described by Aizenstein et al. 
# The first step is to remove the outliers from a set of control participants' total neocortical
# SUVR. This step uses the removeOutliersStDev function with a standard deviation of 1.5. Then,
# with the cleaned data, it determines and returns the value of the upper inner fence, returning
# a single number as the PIB+ cutoff score.
...
# This function returns a vector of values where 1 = greater than cutoff score (PIB+) and 0
# is PIB-.
